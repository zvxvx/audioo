const News = () => {
  return (
    <div className="pb-5 px-5">
      <hr className="border-2 border-slate-300/20 mb-2 rounded" />
      ...
      <hr className="border-2 border-slate-300/20 my-2 rounded" />
      <p className="text-2xl uppercase tracking-wide font-bold">Updates</p>
      <article>
        <span className="italic text-lg">{new Date(2023, 11, 10).toDateString()}</span> | <span className="font-bold text-lg">The Refactor</span>
